...
const componentParser = function(component = null, subcomponentHandlers = []) {
    ...
    return (function(componentContainers, componentContents) {
        ...
        return componentContainers.map((container, index) => {
            return parseJsonObjectToComponentContainers(container.containerType, container.containerAttributes, container.containerContents, componentContents, index);
        });
